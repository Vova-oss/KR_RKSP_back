...
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    public JWTAuthorizationFilter(AuthenticationManager authenticationManager, JwtTokenInputBoundary jwtTokenInputBoundary) {
    ...
    private UsernamePasswordAuthenticationToken getAuthentication(HttpServletRequest request, HttpServletResponse response){
        ...
        if(header != null){
            ...
            try {
                ...
                String login = jwtTokenInputBoundary.getNameFromJWT(token);
                String role = jwtTokenInputBoundary.getRoleFromJWT(token);
                ...
                StaticMethods.createResponse(request, response, 400, "Token was expired");
                return null;
            }
            return null;
        }
